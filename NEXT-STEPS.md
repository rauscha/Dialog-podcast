...
- [ ] **Phase B** — emotion threading (B1, quick win, ~30 min) → edge-trim + variable gaps (B2, **coordinate with A3's crossfade — single ruler: trim → gap → tiny edge crossfade, don't double-apply**) → disfluency/backchannel pass (B3) → overlaid backchannels (B4, stretch).
